...
<body>
    ...
    <div class="loginbox">
            ...
            <br>
        <font style="font-family: 'Bahnschrift', sans-serif; font-size: 30px; color: white;"><b>JOB RECRUITER SIGN IN</b></font>

        
        <form action="./includes/recruiter.login.inc.php" method="post">
            ...
            ?>
            <br>
            <font style="color:white">Don't have an account? <a href="recruitersignup.php">Sign Up</a></font>
