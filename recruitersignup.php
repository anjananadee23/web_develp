...
<body>
    ...
    <div class="signupbox">
            ...
            <br>
        <font style="font-family: 'Bahnschrift', sans-serif; font-size: 30px; color: white;"><b>JOB RECRUITER SIGN UP</b></font>

        <form action="./includes/recruitersignup.inc.php" method="post">
        ...
        <table style="width:70%;">
            ...
            <tr>
                <td style="width:40%"><label>Company Name</label></td>
                <td><input class="inputfield" name="comname" type="text"></td>
            </tr>
            <tr>
                <td><label>Company Address</label></td>
                <td><input class="inputfield" name="comaddress" type="text"></td>
            </tr>
            <tr>
            ...
            ?>
            <br>
            <font style="color:white">Already have an account? <a href="reclogin.php">Log In</a></font>
