...
<html>
<head>
    <title>Information Technology/Software</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Information Technology/Software</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Information Technology/Software' ORDER BY createdTime Desc";
                // Execute the query
