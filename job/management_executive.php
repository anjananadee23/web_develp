...
<html>
<head>
    <title>Management/Executive</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Management/Executive</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Management/Executive' ORDER BY createdTime Desc";
                // Execute the query
