...
<html>
<head>
    <title>Social Services/Non-profit</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Social Services/Non-profit</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Social Services/Non-profit' ORDER BY createdTime Desc";
                // Execute the query
