...
<html>
<head>
    <title>Customer Service/Call Center</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Customer Service/Call Center</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Customer Service/Call Center' ORDER BY createdTime Desc";
                // Execute the query
