...
<html>
<head>
    <title>Sales/Business Development</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Sales/Business Development</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Sales/Business Development' ORDER BY createdTime Desc";
                // Execute the query
