    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Real Estate/Property Management</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Real Estate/Property Management' ORDER BY createdTime Desc";
                // Execute the query
