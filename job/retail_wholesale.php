    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Retail/Wholesale</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Retail/Wholesale' ORDER BY createdTime Desc";
                // Execute the query
