...
<html>
<head>
    <title>Administration/Office Support</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Administration/Office Support</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Administration/Office Support' ORDER BY createdTime Desc";
                // Execute the query
