...
<html>
<head>
    <title>Writing/Editing/Publishing</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Writing/Editing/Publishing</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Writing/Editing/Publishing' ORDER BY createdTime Desc";
                // Execute the query
