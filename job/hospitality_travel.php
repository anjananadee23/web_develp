...
<html>
<head>
    <title>Hospitality/Travel</title>
    ...
    <article>
        ...
        <div class="width-100 recent-job">
            <div class="jobcontainer">
                <h2 class="recent-job-heading">Hospitality/Travel</h2>
                ...
                $sql = "SELECT * FROM job_data WHERE jobCategory='Hospitality/Travel' ORDER BY createdTime Desc";
                // Execute the query
