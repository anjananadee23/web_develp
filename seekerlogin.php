...
<body>
    ...
    <div class="loginbox">
            ...
            <br>
        <font style="font-family: 'Bahnschrift', sans-serif; font-size: 30px; color: white;"><b>JOB SEEKER SIGN IN</b></font>

        
        <form action="./includes/seeker.login.inc.php" method="post">
